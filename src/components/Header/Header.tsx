    ...
    <header className={HeaderCss.header}>
      <div className={HeaderCss.header__wrapper}>
        <div className={HeaderCss.header__menu}>
          <Link
            to="/menu"
            className={`${HeaderCss.button} ${HeaderCss.button_cursor} ${HeaderCss.button_menu}`}
          >
        ...
        <div>
          <ul className={HeaderCss.header__rightblock}>
            ...
            <li className={HeaderCss.cartItem}>
              <span className={HeaderCss.count__cart}>
                {countInCart.length}
              </span>{" "}
              {/* количество товара в корзине*/}
              <Link
                to="/cart"
                className={`${HeaderCss.button} ${HeaderCss.cart}`}
              >
